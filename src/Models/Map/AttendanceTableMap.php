...
class AttendanceTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Models.Map.AttendanceTableMap';
     ...
     */
    const OM_CLASS = '\\Core\\Models\\Attendance';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Models.Attendance';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'TraineeId', 'Timestamp', ),
        self::TYPE_CAMELNAME     => array('id', 'traineeId', 'timestamp', ),
        self::TYPE_COLNAME       => array(AttendanceTableMap::COL_ID, AttendanceTableMap::COL_TRAINEE_ID, AttendanceTableMap::COL_TIMESTAMP, ),
        self::TYPE_FIELDNAME     => array('id', 'trainee_id', 'timestamp', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'TraineeId' => 1, 'Timestamp' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'traineeId' => 1, 'timestamp' => 2, ),
        self::TYPE_COLNAME       => array(AttendanceTableMap::COL_ID => 0, AttendanceTableMap::COL_TRAINEE_ID => 1, AttendanceTableMap::COL_TIMESTAMP => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'trainee_id' => 1, 'timestamp' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    {
        $this->addRelation('Trainee', '\\Core\\Models\\Trainee', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':trainee_id',
    1 => ':id',
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(AttendanceTableMap::COL_TRAINEE_ID);
            $criteria->addSelectColumn(AttendanceTableMap::COL_TIMESTAMP);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.trainee_id');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Core\Models\Attendance) { // it's a model object
