...
abstract class Attendance implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Core\\Models\\Map\\AttendanceTableMap';
    ...
    /**
     * The value for the trainee_id field.
     *
     * @var        int
     */
    ...
    /**
     * Initializes internal state of Core\Models\Base\Attendance object.
     */
    ...
    /**
     * Get the [trainee_id] column value.
     *
     * @return int
     */
     ...
     * @return $this|\Core\Models\Attendance The current object (for fluent API support)
     */
    ...
    /**
     * Set the value of [trainee_id] column.
     *
     * @param int $v New value
     * @return $this|\Core\Models\Attendance The current object (for fluent API support)
     */
    public function setTraineeId($v)
    {
        ...
        if ($this->trainee_id !== $v) {
            $this->trainee_id = $v;
            $this->modifiedColumns[AttendanceTableMap::COL_TRAINEE_ID] = true;
        }

        if ($this->aTrainee !== null && $this->aTrainee->getId() !== $v) {
            $this->aTrainee = null;
        }
    ...
    public function setTimestamp($v)
    {
        ...
        if ($this->timestamp !== null || $dt !== null) {
            if ($this->timestamp === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->timestamp->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[AttendanceTableMap::COL_TIMESTAMP] = true;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : AttendanceTableMap::translateFieldName('TraineeId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->trainee_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : AttendanceTableMap::translateFieldName('Timestamp', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = AttendanceTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Core\\Models\\Attendance'), 0, $e);
        }
    }
    ...
    {
        if ($this->aTrainee !== null && $this->trainee_id !== $this->aTrainee->getId()) {
            $this->aTrainee = null;
        }
    } // ensureConsistency
    ...
    protected function doSave(ConnectionInterface $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aTrainee !== null) {
                if ($this->aTrainee->isModified() || $this->aTrainee->isNew()) {
                    $affectedRows += $this->aTrainee->save($con);
                }
                $this->setTrainee($this->aTrainee);
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(AttendanceTableMap::COL_TRAINEE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'trainee_id';
        }
        if ($this->isColumnModified(AttendanceTableMap::COL_TIMESTAMP)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'id':
                        ...
                        break;
                    case 'trainee_id':
                        $stmt->bindValue($identifier, $this->trainee_id, PDO::PARAM_INT);
                        break;
                    case 'timestamp':
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aTrainee) {
                ...
                $result[$key] = $this->aTrainee->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Core\Models\Attendance
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Core\Models\Attendance The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AttendanceTableMap::COL_TRAINEE_ID)) {
            $criteria->add(AttendanceTableMap::COL_TRAINEE_ID, $this->trainee_id);
        }
        if ($this->isColumnModified(AttendanceTableMap::COL_TIMESTAMP)) {
            $criteria->add(AttendanceTableMap::COL_TIMESTAMP, $this->timestamp);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Core\Models\Attendance (or compatible) type.
    ...
    {
        $copyObj->setTraineeId($this->getTraineeId());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Core\Models\Attendance Clone of current object.
     * @throws PropelException
     */
    ...
    /**
     * Declares an association between this object and a ChildTrainee object.
     *
     * @param  ChildTrainee $v
     * @return $this|\Core\Models\Attendance The current object (for fluent API support)
     * @throws PropelException
     */
    public function setTrainee(ChildTrainee $v = null)
    {
        if ($v === null) {
        ...
        // If this object has already been added to the ChildTrainee object, it will not be re-added.
        if ($v !== null) {
    ...
    /**
     * Get the associated ChildTrainee object
     *
     * @param  ConnectionInterface $con Optional Connection object.
     * @return ChildTrainee The associated ChildTrainee object.
     * @throws PropelException
     */
    public function getTrainee(ConnectionInterface $con = null)
    {
        if ($this->aTrainee === null && ($this->trainee_id != 0)) {
            $this->aTrainee = ChildTraineeQuery::create()->findPk($this->trainee_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aTrainee->addAttendances($this);
             */
        }

        return $this->aTrainee;
    }
    ...
    {
        if (null !== $this->aTrainee) {
            $this->aTrainee->removeAttendance($this);
        }
        $this->id = null;
